  ...
  <div id="content" class="site-content">
    <div id="primary" class="content-area">
      ...
      <main id="main" class="site-main bg-light bg-opacity-50">
        ...
        <header class="entry-header featured-full-width-img height-75 bg-dark text-white mb-3" style="background-image: linear-gradient(to bottom, rgba(223, 209, 194, 0.3), rgba(223, 209, 194, 0.5)), url('<?= $thumb['0']; ?>')">
